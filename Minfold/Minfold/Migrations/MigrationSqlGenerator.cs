                ...
                if (needsDefault)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(column.DefaultConstraintValue))
                    {
                        ...
                        constraintName = !string.IsNullOrWhiteSpace(column.DefaultConstraintName)
                            ...
                            : $"DF_{tableName}_{column.Name}_{GenerateDeterministicSuffix(tableName, column.Name, defaultValue, "add")}";
                    }
                    else
                    {
                        ...
                        constraintName = $"DF_{tableName}_{column.Name}_{GenerateDeterministicSuffix(tableName, column.Name, defaultValue, "add", "temp")}";
                    }
                    ...
                    if (string.IsNullOrWhiteSpace(column.DefaultConstraintValue))
                    {
                        ...
                        string dropVarSuffix = GenerateDeterministicSuffix(tableName, column.Name, defaultValue, "add", "temp");
            ...
            if (!string.IsNullOrWhiteSpace(newColumn.DefaultConstraintValue))
            {
                ...
                constraintName = !string.IsNullOrWhiteSpace(newColumn.DefaultConstraintName)
                    ...
                    : (!string.IsNullOrWhiteSpace(oldColumn.DefaultConstraintName)
                        ...
                        : $"DF_{tableName}_{newColumn.Name}_{GenerateDeterministicSuffix(tableName, newColumn.Name, defaultValue, "alter")}");
            }
            else
            {
                // No default constraint - generate one based on type (temporary)
                defaultValue = GetDefaultValueForType(newColumn.SqlType);
                constraintName = $"DF_{tableName}_{newColumn.Name}_{GenerateDeterministicSuffix(tableName, newColumn.Name, defaultValue, "alter", "temp")}";
            }
