...
public static class SqlDbTypeExtHelpers
{
    ...
    {
        {SqlDbTypeExt.Udt, 28},
        {SqlDbTypeExt.Json, 27},
        {SqlDbTypeExt.Xml, 26},
        {SqlDbTypeExt.DateTimeOffset, 25},
        {SqlDbTypeExt.DateTime2, 24},
        {SqlDbTypeExt.DateTime, 23},
        {SqlDbTypeExt.SmallDateTime, 22},
        {SqlDbTypeExt.Date, 21},
        {SqlDbTypeExt.Time, 20},
        ...
        {SqlDbTypeExt.Int, 13},
        {SqlDbTypeExt.SmallInt, 12},
        {SqlDbTypeExt.TinyInt, 11},
        {SqlDbTypeExt.Bit, 10},
        {SqlDbTypeExt.NText, 9},
        {SqlDbTypeExt.Text, 8},
        {SqlDbTypeExt.Image, 7},
        {SqlDbTypeExt.Timestamp, 6},
        {SqlDbTypeExt.UniqueIdentifier, 5},
        {SqlDbTypeExt.NVarChar, 4},
        {SqlDbTypeExt.NChar, 3},
        {SqlDbTypeExt.VarChar, 2},
        {SqlDbTypeExt.Char, 1},
        {SqlDbTypeExt.VarBinary, 0},
        {SqlDbTypeExt.Binary, -1}
    };   
}
